...
#[test]
fn session_header_display_lines_are_hidden() {
...
#[test]
fn session_header_raw_lines_are_hidden() {
    let cell = SessionHeaderHistoryCell::new(
        "gpt-4o".to_string(),
        Some(ReasoningEffortConfig::High),
        /*show_fast_status*/ false,
    ...
    assert_eq!(Vec::<String>::new(), render_lines(&cell.raw_lines()));
}

#[test]
fn session_header_yolo_mode_stays_hidden() {
    let cell = SessionHeaderHistoryCell::new(
        "gpt-5".to_string(),
        /*reasoning_effort*/ None,
        /*show_fast_status*/ false,
